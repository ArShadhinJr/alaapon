...
const Input = (props) => {
  return (
    <div className="relative z-0 w-full mt-6 group">
      <input type={props.type} name={props.name} id={props.type} value={props.value} onChange={props.onChange} className="block py-2.5 px-0 w-full text-base bg-transparent border-0 border-b-2 border-white appearance-none focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " />
